! function() {
    ...
    if (window.jQuery && jQuery.fn && jQuery.fn.select22 && jQuery.fn.select22.amd) var e = jQuery.fn.select22.amd.define,
        t = jQuery.fn.select22.amd.require;
    var n, t, e;
    ! function(r) {
        function i(e, t) {
            return _.call(e, t)
        ...
        f = function(e, t) {
            ...
            var e = jQuery || $;
            return null == e && console && console.error && console.error("select22: An instance of jQuery or a jQuery-compatible library was not found. Make sure that you are including jQuery before select22 on your web page."), e
        }), e("select22/utils", [], function() {
            function e(e) {
                var t = e.prototype,
                    n = [];
                for (var r in t) {
        ...
        }), e("select22/results", ["jquery", "./utils"], function(e, t) {
            function n(e, t, r) {
                this.$element = e, this.data = r, this.options = t, n.__super__.constructor.call(this)
            }
            return t.Extend(n, t.Observable), n.prototype.render = function() {
                var t = e('<ul class="select22-results__options" role="tree"></ul>');
                return this.options.get("multiple") && t.attr("aria-multiselectable", "true"), this.$results = t, t
            }, n.prototype.clear = function() {
                this.$results.empty()
            }, n.prototype.displayMessage = function(t) {
                this.clear(), this.hideLoading();
                var n = e('<li role="treeitem" class="select22-results__option"></li>'),
                ...
                this.data.current(function(n) {
                    var r = e.map(n, function(e) {
                        ...
                        i = t.$results.find(".select22-results__option[aria-selected]");
                    i.each(function() {
                        var t = e(this),
                            n = e.data(this, "data");
                ...
                n.className = "select22-results__option";
                var r = {
                    role: "treeitem",
                    "aria-selected": "false"
                };
                ...
                if (t.children) {
                    ...
                    a.className = "select22-results__group"; {
                        e(a)
                    }
                    this.template(t, a);
                    ...
                    var h = e("<ul></ul>", {
                        "class": "select22-results__options select22-results__options--nested"
                    });
                ...
                this.$results.attr("id", r), t.on("results:all", function(e) {
                    ...
                    e.element.addClass("select22-results__option--highlighted")
                ...
                }), this.$results.on("mouseup", ".select22-results__option[aria-selected]", function(t) {
                    var r = e(this),
                        i = r.data("data");
                ...
                }), this.$results.on("mouseenter", ".select22-results__option[aria-selected]", function() {
                    var t = e(this).data("data");
                    n.getHighlightedResults().removeClass("select22-results__option--highlighted"), n.trigger("results:focus", {
                        data: t,
                        element: e(this)
                    })
                })
            }, n.prototype.getHighlightedResults = function() {
                var e = this.$results.find(".select22-results__option--highlighted");
                return e
            ...
            return e
        }), e("select22/selection/base", ["jquery", "../utils", "../keys"], function(e, t, n) {
            function r(e, t) {
                this.$element = e, this.options = t, r.__super__.constructor.call(this)
            }
            return t.Extend(r, t.Observable), r.prototype.render = function() {
                var t = e('<span class="select22-selection" tabindex="0" role="combobox" aria-autocomplete="list" aria-haspopup="true" aria-expanded="false"></span>');
                ...
                e(document.body).on("mousedown.select22." + t.id, function(t) {
                    var n = e(t.target),
                        r = n.closest(".select22"),
                        i = e(".select22.select22-container--open");
                    i.each(function() {
                        var t = e(this);
                        if (this != r[0]) {
                ...
                e(document.body).off("mousedown.select22." + t.id)
        ...
        }), e("select22/selection/single", ["jquery", "./base", "../utils", "../keys"], function(e, t, n) {
            function r() {
                r.__super__.constructor.apply(this, arguments)
            }
            return n.Extend(r, t), r.prototype.render = function() {
                var e = r.__super__.render.call(this);
                return e.addClass("select22-selection--single"), e.html('<span class="select22-selection__rendered"></span><span class="select22-selection__arrow" role="presentation"><b role="presentation"></b></span>'), e
            }, r.prototype.bind = function(e) {
                var t = this;
                r.__super__.bind.apply(this, arguments);
                var n = e.id + "-container";
                this.$selection.find(".select22-selection__rendered").attr("id", n), this.$selection.attr("aria-labelledby", n), this.$selection.on("mousedown", function(e) {
                ...
                this.$selection.find(".select22-selection__rendered").empty()
                ...
                var t = e[0],
                    n = this.display(t);
                this.$selection.find(".select22-selection__rendered").html(n)
            }, r
        }), e("select22/selection/multiple", ["jquery", "./base", "../utils"], function(e, t, n) {
            function r() {
                r.__super__.constructor.apply(this, arguments)
            }
            return n.Extend(r, t), r.prototype.render = function() {
                var e = r.__super__.render.call(this);
                return e.addClass("select22-selection--multiple"), e.html('<ul class="select22-selection__rendered"></ul>'), e
                ...
                }), this.$selection.on("click", ".select22-selection__choice__remove", function(n) {
                    var r = e(this),
                        i = r.parent(),
                        o = i.data("data");
                    t.trigger("unselect", {
                ...
                var t = e('<li class="select22-selection__choice"><span class="select22-selection__choice__remove" role="presentation">&times;</span></li>');
                return t
            }, r.prototype.update = function(e) {
                if (this.clear(), 0 !== e.length) {
                    ...
                    this.$selection.find(".select22-selection__rendered").append(t)
                }
            }, r
        }), e("select22/selection/placeholder", ["../utils"], function() {
            function e(e, t, n) {
            ...
            return e.prototype.normalizePlaceholder = function(e, t) {
                ...
                return n.html(this.display(t)), n.addClass("select22-selection__placeholder").removeClass("select22-selection__choice"), n
                ...
                this.$selection.find(".select22-selection__rendered").append(i)
            }, e
        }), e("select22/selection/allowClear", ["jquery"], function(e) {
            function t() {}
            return t.prototype.bind = function(t, n, r) {
                var i = this;
                t.call(this, n, r), this.$selection.on("mousedown", ".select22-selection__clear", function(t) {
                ...
                if (t.call(this, n), !(this.$selection.find(".select22-selection__placeholder").length > 0 || 0 === n.length)) {
                    var r = e('<span class="select22-selection__clear">&times;</span>');
                    r.data("data", n), this.$selection.find(".select22-selection__rendered").append(r)
                }
            }, t
        }), e("select22/selection/search", ["jquery", "../utils", "../keys"], function(e, t, n) {
            function r(e, t, n) {
                e.call(this, t, n)
            }
            return r.prototype.render = function(t) {
                var n = e('<li class="select22-search select22-search--inline"><input class="select22-search__field" type="search" tabindex="-1" role="textbox" /></li>');
                ...
                }), this.$selection.on("keydown", ".select22-search--inline", function(e) {
                    e.stopPropagation(), i.trigger("keypress", e), i._keyUpPrevented = e.isDefaultPrevented();
                    var t = e.which;
                    if (t === n.BACKSPACE && "" === i.$search.val()) {
                        var r = i.$searchContainer.prev(".select22-selection__choice");
                        if (r.length > 0) {
                            var o = r.data("data");
                            i.searchRemoveChoice(o)
                        }
                    }
                }), this.$selection.on("keyup", ".select22-search--inline", function(e) {
                    i.handleSearch(e)
                })
            }, r.prototype.createPlaceholder = function(e, t) {
                this.$search.attr("placeholder", t.text)
            }, r.prototype.update = function(e, t) {
                this.$search.attr("placeholder", ""), e.call(this, t), this.$selection.find(".select22-selection__rendered").append(this.$searchContainer), this.resizeSearch()
                ...
                var e = "";
                if ("" !== this.$search.attr("placeholder")) e = this.$selection.find(".select22-selection__rendered").innerWidth();
                else {
        ...
        }), e("select22/selection/eventRelay", ["jquery"], function(e) {
            function t() {}
            return t.prototype.bind = function(t, n, r) {
                var i = this,
        ...
        }), e("select22/translation", ["jquery"], function(e) {
            function n(e) {
                this.dict = e || {}
            }
        ...
        }), e("select22/diacritics", [], function() {
            var e = {
                "Ⓐ": "A",
                "Ａ": "A",
                "À": "A",
            ...
            return e
        }), e("select22/data/base", ["../utils"], function(e) {
            function t() {
        ...
        }), e("select22/data/select", ["./base", "../utils", "jquery"], function(e, t, n) {
            function r(e, t) {
                this.$element = e, this.options = t, r.__super__.constructor.call(this)
            }
        ...
        }), e("select22/data/array", ["./select", "../utils", "jquery"], function(e, t, n) {
            function r(e, t) {
                var n = t.get("data") || [];
        ...
        }), e("select22/data/ajax", ["./array", "../utils", "jquery"], function(e, t, n) {
            function r(t, n) {
            ...
            return t.Extend(r, e), r.prototype.processResults = function(e) {
                ...
                function r() {
                    ...
                    r.success(function(r) {
                        ...
                        console && console.error && (o && o.results && n.isArray(o.results) || console.error("select22: The AJAX results did not return an array in the `results` key of the response.")), t(o)
                    }), i._request = r
                }
                var i = this;
        ...
        }), e("select22/data/tags", ["jquery"], function(e) {
            function t(t, n, r) {
                var i = r.get("tags"),
                    o = r.get("createTag");
            ...
            return t.prototype.query = function(e, t, n) {
                function r(e, o) {
                    ...
                    if (null != d) {
                        var h = i.option(d);
                        h.attr("data-select22-tag", !0), i.$element.append(h), i.insertTag(s, d)
                    }
                    e.results = s, n(e)
                }
                var i = this;
                ...
                var t = (this._lastTag, this.$element.find("option[data-select22-tag]"));
                t.each(function() {
                    this.selected || e(this).remove()
                })
            }, t
        }), e("select22/data/tokenizer", ["jquery"], function(e) {
            function t(e, t, n) {
                var r = n.get("tokenizer");
                void 0 !== r && (this.tokenizer = r), e.call(this, t, n)
            }
            return t.prototype.bind = function(e, t, n) {
                e.call(this, t, n), this.$search = t.dropdown.$search || t.selection.$search || n.find(".select22-search__field")
        ...
        }), e("select22/data/minimumInputLength", [], function() {
            function e(e, t, n) {
        ...
        }), e("select22/data/maximumInputLength", [], function() {
            function e(e, t, n) {
        ...
        }), e("select22/data/maximumSelectionLength", [], function() {
            function e(e, t, n) {
        ...
        }), e("select22/dropdown", ["jquery", "./utils"], function(e, t) {
            function n(e, t) {
                this.$element = e, this.options = t, n.__super__.constructor.call(this)
            }
            return t.Extend(n, t.Observable), n.prototype.render = function() {
                var t = e('<span class="select22-dropdown"><span class="select22-results"></span></span>');
        ...
        }), e("select22/dropdown/search", ["jquery", "../utils"], function(e) {
            function t() {}
            return t.prototype.render = function(t) {
                var n = t.call(this),
                    r = e('<span class="select22-search select22-search--dropdown"><input class="select22-search__field" type="search" tabindex="-1" role="textbox" /></span>');
                ...
                e.call(this, t, n), this.$search.on("keydown", function(e) {
                    ...
                    if (null == e.query.term || "" === e.query.term) {
                        ...
                        t ? r.$searchContainer.removeClass("select22-search--hide") : r.$searchContainer.addClass("select22-search--hide")
                    }
                })
        ...
        }), e("select22/dropdown/hidePlaceholder", [], function() {
            function e(e, t, n, r) {
        ...
        }), e("select22/dropdown/infiniteScroll", ["jquery"], function(e) {
            function t(e, t, n, r) {
        ...
        }), e("select22/dropdown/attachBody", ["jquery", "../utils"], function(e, t) {
            function n(e, t, n) {
            ...
            return n.prototype.bind = function(e, t, n) {
                ...
                t.attr("class", n.attr("class")), t.removeClass("select22"), t.addClass("select22-container--open"), t.css({
                    position: "absolute",
                    top: -999999
                }), this.$container = n
                ...
                var r = this,
                    i = "scroll.select22." + n.id,
                    o = "resize.select22." + n.id,
                    s = "orientationchange.select22." + n.id;
                $watchers = this.$container.parents().filter(t.hasScroll), $watchers.each(function() {
                    e(this).data("select22-scroll-position", {
                        x: e(this).scrollLeft(),
                        y: e(this).scrollTop()
                    })
                }), $watchers.on(i, function() {
                    var t = e(this).data("select22-scroll-position");
                    e(this).scrollTop(t.y)
                }), e(window).on(i + " " + o + " " + s, function() {
                    r._positionDropdown(), r._resizeDropdown()
                })
            }, n.prototype._detachPositioningHandler = function(n) {
                var r = "scroll.select22." + n.id,
                    i = "resize.select22." + n.id,
                    o = "orientationchange.select22." + n.id;
                $watchers = this.$container.parents().filter(t.hasScroll), $watchers.off(r), e(window).off(r + " " + i + " " + o)
            }, n.prototype._positionDropdown = function() {
                var t = e(window),
                    n = this.$dropdown.hasClass("select22-dropdown--above"),
                    r = this.$dropdown.hasClass("select22-dropdown--below"),
                    i = null,
                ...
                n || r || (i = "below"), u || !c || n ? !c && u && n && (i = "below") : i = "above", ("above" == i || n && "below" !== i) && (d.top = s.top - a.height), null != i && (this.$dropdown.removeClass("select22-dropdown--below select22-dropdown--above").addClass("select22-dropdown--" + i), this.$container.removeClass("select22-container--below select22-container--above").addClass("select22-container--" + i)), this.$dropdownContainer.css(d)
        ...
        }), e("select22/dropdown/minimumResultsForSearch", [], function() {
            function e(t) {
                count = 0;
        ...
        }), e("select22/dropdown/selectOnClose", [], function() {
            function e() {}
        ...
        }), e("select22/defaults", ["jquery", "./results", "./selection/single", "./selection/multiple", "./selection/placeholder", "./selection/allowClear", "./selection/search", "./selection/eventRelay", "./utils", "./translation", "./diacritics", "./data/select", "./data/array", "./data/ajax", "./data/tags", "./data/tokenizer", "./data/minimumInputLength", "./data/maximumInputLength", "./data/maximumSelectionLength", "./dropdown", "./dropdown/search", "./dropdown/hidePlaceholder", "./dropdown/infiniteScroll", "./dropdown/attachBody", "./dropdown/minimumResultsForSearch", "./dropdown/selectOnClose", "./i18n/en"], function(e, n, r, i, o, s, a, l, c, u, d, h, p, f, g, m, v, y, w, _, $, b, x, A, O, S, E) {
            function C() {
                this.reset()
            }
                    ...
                    for (var L = d.language, P = 0; P < L.length; P++) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                console && console.warn && console.warn('select22: The lanugage file for "' + I + '" could not be automatically loaded. A fallback will be used instead.');
                                continue
                            }
                        }
                        j.extend(k)
        ...
        }), e("select22/core", ["jquery", "./options", "./utils", "./keys"], function(e, t, n, r) {
            var o = function(e, n) {
                null != e.data("select22") && e.data("select22").destroy(), this.$element = e, this.id = this._generateId(e), n = n || {}, this.options = new t(n, e), o.__super__.constructor.call(this);
                ...
                }), e.hide(), this._syncAttributes(), this._tabindex = e.attr("tabindex") || 0, e.attr("tabindex", "-1"), e.data("select22", this)
            };
            return n.Extend(o, n.Observable), o.prototype._generateId = function(e) {
                var t = "";
                return t = null != e.attr("id") ? e.attr("id") : null != e.attr("name") ? e.attr("name") + "-" + n.generateChars(2) : n.generateChars(4), t = "select22-" + t
                ...
                var t = this;
                this.$element.on("change.select22", function() {
                ...
                this.on("open", function() {
                    e.$container.addClass("select22-container--open")
                }), this.on("close", function() {
                    e.$container.removeClass("select22-container--open")
                }), this.on("enable", function() {
                    e.$container.removeClass("select22-container--disabled")
                }), this.on("disable", function() {
                    e.$container.addClass("select22-container--disabled")
                ...
                return this.$container.hasClass("select22-container--open")
            }, o.prototype.enable = function(e) {
                console && console.warn && console.warn('select22: The `select22("enable")` method has been deprecated and will be removed in later select22 versions. Use $element.prop("disabled") instead.'), 0 === e.length && (e = [!0]);
                var t = !e[0];
                this.$element.prop("disabled", t)
            }, o.prototype.val = function(t) {
                if (console && console.warn && console.warn('select22: The `select22("val")` method has been deprecated and will be removed in later select22 versions. Use $element.val() instead.'), 0 === t.length) return this.$element.val();
                var n = t[0];
                e.isArray(n) && (n = e.map(n, function(e) {
                    return e.toString()
                })), this.$element.val(n).trigger("change")
            }, o.prototype.destroy = function() {
                this.$container.remove(), this.$element[0].detachEvent && this.$element[0].detachEvent("onpropertychange", this._sync), null != this._observer && (this._observer.disconnect(), this._observer = null), this._sync = null, this.$element.off(".select22"), this.$element.attr("tabindex", this._tabindex), this.$element.show(), this.$element.removeData("select22"), this.data.destroy(), this.selection.destroy(), this.dropdown.destroy(), this.results.destroy(), this.data = null, this.selection = null, this.dropdown = null, this.results = null
            }, o.prototype.render = function() {
                var t = e('<span class="select22 select22-container"><span class="selection"></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>');
                return t.attr("dir", this.options.get("dir")), this.$container = t, this.$container.addClass("select22-container--" + this.options.get("theme")), t.data("element", this.$element), t
            }, o
        }),
        function(t) {
        ...
        }), e("select22/compat/matcher", ["jquery"], function(e) {
            function t(t) {
                function n(n, r) {
                    var i = e.extend(!0, {}, r);
            ...
            return t
        }), e("select22/compat/initSelection", ["jquery"], function(e) {
            function t(e, t, n) {
                console && console.warn && console.warn("select22: The `initSelection` option has been deprecated in favor of a custom data adapter that overrides the `current` method. This method is now called multiple times instead of a single time when the instance is initialized. Support will be removed for the `initSelection` option in future versions of select22"), this.initSelection = n.get("initSelection"), this._isInitialized = !1, e.call(this, t, n)
            }
        ...
        }), e("select22/compat/query", [], function() {
            function e(e, t, n) {
                console && console.warn && console.warn("select22: The `query` option has been deprecated in favor of a custom data adapter that overrides the `query` method. Support will be removed for the `query` option in future versions of select22."), e.call(this, t, n)
            }
            return e.prototype.query = function(e, t, n) {
                t.callback = n;
        ...
        }), e("select22/dropdown/attachContainer", [], function() {
            function e(e, t, n) {
                e.call(this, t, n)
            }
            return e.prototype.position = function(e, t, n) {
                var r = n.find(".dropdown-wrapper");
                r.append(t), t.addClass("select22-dropdown--below"), n.addClass("select22-container--below")
            }, e
        }), e("jquery.select22", ["jquery", "./select22/core", "./select22/defaults"], function(e, n, r) {
            try {
                t("jquery.mousewheel")
            } catch (i) {}
            return null == e.fn.select22 && (e.fn.select22 = function(t) {
                ...
                if ("string" == typeof t) {
                    var r = this.data("select22"),
                        i = Array.prototype.slice.call(arguments, 1);
                    return r[t](i)
                }
                throw new Error("Invalid arguments for select22: " + t)
            }), null == e.fn.select22.defaults && (e.fn.select22.defaults = r), n
        }), t("jquery.select22"), jQuery.fn.select22.amd = {
            define: e,
            require: t
        }
}();