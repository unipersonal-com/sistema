 ...
 */
(function(t){
    "function"==typeof define&&define.amd?define(["jquery","moment"],t):t(jQuery,moment)})(function(t,e){
    function n(t){i(Ee,t)
    }
    function i(e){
        function n(n,s){
        ...
        for(var s=1;arguments.length>s;s++)
            t.each(arguments[s],n);
        return e
    }function r(t){
