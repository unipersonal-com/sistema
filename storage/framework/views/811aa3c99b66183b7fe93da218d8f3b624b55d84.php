...
<html lang="en" style="background-color: #f5f5f5;">
    ...
    <body style="background-image: url(assets/images/uatfblanco.png); background-size: 100PX;">
        <div class="container">
            ...
            <div id="cuerpo1">
                <p style="float:left; padding: 2px 10px 2px 10px;">NOMBRE DEL(A) FUNCIONARIO (A): <?php echo e($persona->nombres); ?> <?php echo e($persona->apellido_paterno); ?> <?php echo e($persona->apellido_materno); ?></p>
                <p style="float: right; padding: 2px 10px 2px 10px;"> CON C.I.: <?php echo e($persona->ci); ?></p>
            </div>
            <div id="cuerpo2">
            ...
            <div id="cuerpo3">
                <p>ESTA AUTORIZADO PARA SALIR POR MOTIVO DE : <b><?php echo e($ultimoevento->descripcion); ?></b></p>
                <p> DESDE HORAS: <b><?php echo e($ultimoevento->inicio_time); ?></b>  HASTA HORAS: <b><?php echo e($ultimoevento->fin_evento); ?></b> PREVISTAMENTE...</p>
                <p>EN FECHA: POTOSI <b><?php echo e($dia); ?></b> DEL MES <b><?php echo e($mes); ?></b> DEL AÑO <b><?php echo e($year); ?></b></p>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\Web\Modules/Rrhh\Resources/views/scarrhh/eventos/eventoAsistencia/pdfAutorizacion.blade.php ENDPATH**/ ?>