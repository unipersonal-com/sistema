<div class="container">
    ...
    <div class="tablas">
        <div class="form-inline" style="text-align: right;font-weight: bold;margin-top: 1px;
          ...
          <h2 style="">Datos Biometrico</h2>
            <button type="button" class="btn btn-primary" id="<?php echo e($id_e); ?>" onclick="activarBio(this.id)">habilitar Biometrico</button>
      ...
      <div class="tabla-usuarios">
        <div class="form-inline" style="text-align: right;font-weight: bold;margin-top: 1px;
          ...
          <h2>Datos Usuarios</h2>
            ...
            <!-- <button type="button" id='<?php echo e($ip); ?>' onclick=" a(this.id, <?php echo e($puerto); ?>)" class="btn btn-warning">VerTipoAsis.</button> -->
        </div>
        <div id="renderUser">
          <table class="table__kirito table-bordered" style="width:99%">
            <thead>
            ...
            // $zk->setUser(new User(1, User::PRIVILEGE_SUPERADMIN, '1', 'Admin', '', '', -3, 1));
              foreach($users as $user):
                ...
                <tr class="">
                  ...
                  <td> <button type="button" onclick ="eliminar (<?php echo e($user['uid']); ?>, '<?php echo e($ip); ?>', '<?php echo e($puerto); ?>',)" class="btn btn-primary eliminarUser" ><i class="fa fa-trash" style="color:white;"></i></button></td>
                </tr>
                <?php
                endforeach;
              } catch (Exception $e) {
    ...
    <div class="tablas">
      <div class="form-inlene" style="text-align: right;font-weight: bold;margin-top: 1px;
        ...
        <h2>Registro de Asistencias</h2>
          ...
          <button type="button" id='<?php echo e($ip); ?>' onclick=" importarAsis(this.id, <?php echo e($puerto); ?>)" class="btn btn-warning">ImportarAsis</button>
      </div>
 ...
 <?php echo $__env->make('rrhh::administrator.biometric.modals.vista-general', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> 
 <?php echo $__env->make('rrhh::administrator.biometric.modals.general-asistencias', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> 
 <?php echo $__env->make('rrhh::administrator.biometric.modals.general-asistencias-tipo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> 
<!-- modal create -->
          ...
          <form class="" novalidate id="formulario-usuario"> 
            ...
            <tr>
              ...
              <td>
                ...
                <button type="submit" id='<?php echo e($ip); ?>' onclick="nuevoUsuario(this.id, <?php echo e($puerto); ?>)" class="btn btn-success">Guardar</button>
...
<script type="text/javascript">
    ...
    function activarBio(id_e){
      var id = id_e;
      console.log(id);
      var url="<?php echo e(url("rrhh/bioconectUpdate")); ?>";
        $.ajax({
            type:'GET',
            url:url,
            data:{'id': id},
    ...
    function importarBiometric(id, puerto){
        ...
        var url="<?php echo e(url("rrhh/bioconectDatosBiometrico")); ?>";
        $.ajax({
            type:'GET',
            url:url,
    ...
    function importarAsis(id, puerto){
        ...
        var puerto = puerto;
        console.log(ip);
        var url="<?php echo e(url("rrhh/bioconectImport")); ?>";
        $.ajax({
            type:'GET',
            url:url,
    ...
    function eliminar(id, ip, puerto){
      ...
      var p=puerto;
      console.log(p);
        var url="<?php echo e(url("rrhh/bioconectDelete")); ?>";
    ...
    function nuevoUsuario(id, puerto){
      ...
      console.log(uid, password, role);
        var url="<?php echo e(url("rrhh/bioconectAgregarUsuario")); ?>";
        $.ajax({
            type:'GET',
            url:url,
...
<script type="text/javascript">
    ...
    $(document).on("click", ".pagination a", function(e) {
        e.preventDefault();
        var id_e = <?php echo e($id_e); ?>;
        var ip = `<?php echo e($ip); ?>`;
        var puerto = <?php echo e($puerto); ?>;
        //`${datos.id}`
...
<?php /**PATH C:\xampp\htdocs\Web\Modules/Rrhh\Resources/views/administrator/biometric/index2.blade.php ENDPATH**/ ?>