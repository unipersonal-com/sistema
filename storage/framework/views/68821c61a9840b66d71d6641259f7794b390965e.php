...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-lg-12">
            ...
            <a class="btn btn-app btn-mycolor" data-toggle="modal" data-target=".create-modal-sm">
                <span class="badge bg-red"><?php echo e(count($grupotrabajo)); ?> registros</span>
    ...
    <?php echo $__env->make('rrhh::scarrhh.grupotrabajo.modals.modal-create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('rrhh::scarrhh.grupotrabajo.modals.modal-edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
...
##parent-placeholder-518cf8338c525b9b9840516cc667fb67f75d82ca##
    ...
    <script>
        function alerta(id,row) {
            ...
            if(bool){
                $.ajax({
                    url:"<?php echo e(url("rrhh/deletegrupo")); ?>",
                    type:"get",
                    data:{"id":id},
    ...
    <script type="text/javascript">
        ...
        function ver(id){
            $.ajax({
                url:"<?php echo e(url("rrhh/getgrupo")); ?>",
                type:"get",
                data:{"id":id},
                success:function(datos){
...
<?php echo $__env->make('rrhh::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Web\Modules/Rrhh\Resources/views/scarrhh/grupotrabajo/index.blade.php ENDPATH**/ ?>