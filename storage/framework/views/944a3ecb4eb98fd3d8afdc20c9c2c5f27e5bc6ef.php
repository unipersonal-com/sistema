        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="background: #CBDEED">
                    ...
                    <a class="btn btn-warning trabajo" id= "<?php echo e($id_persona); ?>" onclick="diastrabajo(this.id, url='<?php echo e(url('rrhh/diastrabajo')); ?>')" 
                                style="margin-top: 2px; color: #fff"><i class="fa fa-undo"></i> Calcular</a>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
    </div><?php /**PATH C:\xampp\htdocs\Web\Modules/Rrhh\Resources/views/scarrhh/AsistenciasActuales/modals/modal-dtrabajo.blade.php ENDPATH**/ ?>