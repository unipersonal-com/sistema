...
<style type="text/css">
    ...
    <section class="team-area section-padding40 section-bg1" style="background-image: linear-gradient(to right top, #a4a7ae, #afb8bd, #bec9c9, #d0d9d5, #e6e9e1);">
        <div class="container">
            ...
            <div class="row">
                <?php $__currentLoopData = $appss; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="my_card" >
                      ...
                      <div class="my_card-footer">
                          <a href="<?php echo e(route('home.dowload.apk',$wb->archivo)); ?>" class="btn my_button">Descargar</a>
                      </div>
...
<?php echo $__env->make('layouts.portal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Web\resources\views/home/apps.blade.php ENDPATH**/ ?>