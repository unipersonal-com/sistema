...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-lg-12">
            ...
            <a class="btn btn-app btn-mycolor" data-toggle="modal" data-target=".create-modal-sm">
                <span class="badge bg-red"><?php echo e(count($tiposalida)); ?> registros</span>
    ...
    <div class="row">
        ...
        <div class = " contpanel">
            ...
            <table class="table__kirito table-bordered">
                ...
                <tbody>
                <?php $__currentLoopData = $tiposalida; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salida): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="mytr">
                        <td class="mytd"><?php echo e($salida->nombre_tiposalida); ?></td>
                        <td class="mytd"><?php echo e($salida->bonote); ?></td>
                        <td>
                            <center>
                            <?php if (Auth::check() && Auth::user()->hasPermission('editar.horario')): ?>
                            <a href="#" title="eliminar" onclick="alerta('<?php echo e($salida->id); ?>',this)"><i class="fa fa-trash"></i></a>

                            <a href="#" id="<?php echo e($salida->id); ?>"  title="editar <?php echo e($salida->id); ?>" onclick="ver(this.id)" data-toggle="modal" data-target=".edit-modal-sm"><i class="fa fa-edit"></i></a>
                            <?php endif; ?>
    ...
    <?php echo $__env->make('rrhh::scarrhh.tiposalida.modals.modal-create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('rrhh::scarrhh.tiposalida.modals.modal-edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
...
##parent-placeholder-518cf8338c525b9b9840516cc667fb67f75d82ca##
    ...
    <script>
        function alerta(id,row) {
            ...
            if(bool){
                $.ajax({
                    url:"<?php echo e(url("rrhh/deletetiposalida")); ?>",
                    type:"get",
                    data:{"id":id},
    ...
    <script type="text/javascript">
        ...
        function ver(id){
            $.ajax({
                url:"<?php echo e(url("rrhh/gettiposalida")); ?>",
                type:"get",
                data:{"id":id},
                success:function(datos){
...
<?php echo $__env->make('rrhh::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Web\Modules/Rrhh\Resources/views/scarrhh/tiposalida/index.blade.php ENDPATH**/ ?>