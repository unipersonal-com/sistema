<div class="conatiner">
        ...
        <script type="text/javascript">
            ...
            eventClick: function(arg) {
                ...
                $(function () {
                    ...
                    $.ajax({
                        ...
                        url:"<?php echo e(url("rrhh/getevento")); ?>",
                        type:"get",
                        data:{"id":id},
            ...
            dayMaxEvents: true,
            events: {
                url: "<?php echo e(url("rrhh/mostrar")); ?>",
                method: "GET",
                extraParams: {
    ...
    <div id='top' >
        ...
        <u style="margin-top: 20px; font-weight: bold; text-aling: center;"><h4 ><?php echo e($title); ?> <b><?php echo e($persona->nombres.' '.$persona->apellido_paterno.' '.$persona->apellido_materno); ?></b> </h4></u> 
                ...
                <tbody>
                    <tr id="calcular_permisos">
                        ...
                        <td><button type="button" class="btn btn-primary" style="background: linear-gradient(156deg, #8E44AD, #9B59B6);">
                            P_Hora <span class="badge badge-light"> <?php echo e($perH); ?> </span>
                            </button> 
                        </td>
                        <td><button type="button" class="btn btn-primary" style='background: #F39C12'>
                            P_Me_Tiempo<span class="badge badge-light"> <?php echo e($perMT); ?> </span>
                            </button> 
                        </td>
                        <td><button type="button" class="btn btn-primary" style="background: #34495e">
                            P_T_Completo <span class="badge badge-light"> <?php echo e($perTC); ?> </span>
                            </button> 
                        </td>
                        <td><button type="button" class="btn btn-primary" style="background: #9fc131">
                            P_F_semana <span class="badge badge-light"> <?php echo e($perFS); ?> </span>
                            </button> 
                        </td>
                        <td><button type="button" class="btn btn-primary" style='background: #3c28b8'>
                            T_Permisos <span class="badge badge-light"> <?php echo e($permisos); ?> </span>
                            </button> 
                        </td>
                    </tr>
                    <tr>
                        <td><button type="button" class="btn btn-primary" style = 'background: linear-gradient(156deg, #1E8449, #117A65)'>
                            T_Horas <span class="badge badge-light"> <?php echo e($perHT); ?> </span>
                            </button> 
                        </td>
                        <td><button type="button" class="btn btn-primary" style='background: #FB8B24'>
                            T_Horas <span class="badge badge-light"> <?php echo e($perMTT); ?> </span>
                            </button> 
                        </td>
                        <td><button type="button" class="btn btn-primary" style='background:#717E7D'>
                            T_Horas <span class="badge badge-light"> <?php echo e($perTCT); ?> </span>
                            </button> 
                        </td>
                        <td ><button type="button" class="btn btn-primary" style='background: #dbf227'>
                            T_Horas <span class="badge badge-light"> <?php echo e($perFST); ?> </span>
                            </button> 
                        </td>
                        <td><button type="button" class="btn btn-primary">
                            T_Horas <span class="badge badge-light"> <?php echo e($perTP); ?> </span>
                            </button> 
                        </td>
                    </tr>
                </tbody>
    ...
    <div id="carga" style="display: none; background-color: #fff; text-align: center;"> <img src="<?php echo e(asset('assets/images/loandig3.gif')); ?>" width="250px" style="color: #900c3f;"></div>
    <div id='wrap'>
        <div id='calendar-wrap'>
            <div id='calendar'></div>
        </div>
    </div>
    <?php echo $__env->make('rrhh::scarrhh.vistasHojaCalculo.modals.modal-create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('rrhh::scarrhh.vistasHojaCalculo.modals.modal-edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('rrhh::scarrhh.vistasHojaCalculo.modals.modal-fechas', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('rrhh::scarrhh.vistasHojaCalculo.modals.modal-fepermiso', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="background: #CBDEED">
                ...
                <div class="d-grid gap-2">
                    <button type="button" href="<?php echo e(route('descargarPDF')); ?>" class="btn btn-success me-md-2"><a class="fa fa-download" target="_blank" style="margin-top: 2px; color: #fff"></a></button>
                    <button type="button" class="btn btn-primary descargar"><a href="<?php echo e(route('descargarAutorizacionPDF')); ?>" class="fa fa-print" target="_blank" style="margin-top: 2px; color: #fff"></a></button>
                </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(document).on('click','#btn_deleteEvento',function(e){
        ...
        console.log(id);
            ...
            if(bool){
                $.ajax({
                    url:"<?php echo e(url("rrhh/deleteEvento")); ?>",
                    type:"get",
                    data:{"id":id},
                    success:function(datos){
                        if(datos.resp==200){
    ...
    function pdfpermiso(id){
        ...
        $.ajax({
            url: "<?php echo e(url("rrhh/pdfpermisos")); ?>",
            type:"get",
...
<?php /**PATH C:\xampp\htdocs\Web\Modules/Rrhh\Resources/views/scarrhh/vistasHojaCalculo/meses.blade.php ENDPATH**/ ?>