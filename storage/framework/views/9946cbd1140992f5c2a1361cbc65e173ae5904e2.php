                        ...
                        <tr>
                           <td>
                            ...
                            <select class="form-control" name="horario_id" id="horario_id">
                                <?php $__currentLoopData = $hoursi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>;
                           ...
                           <td>
                              ...
                              <input type="text" class="form-control" name="personal" id="personal" value = "<?php echo e($persona->nombres.' '.$persona->apellido_paterno); ?>"readonly>
                           </td> 
                           <td hidden="true">
                              <label for="personal_id" class="form-label">Personas</label>
                              <input type="text" class="form-control" name="personal_id" id="personal_id" value = "<?php echo e($id_persona); ?>"readonly>
                           </td> 
                        </tr>
...
<script type="text/javascript">
    $(document).on('click','.designarGuardarPersonal', function(e) {
        ...
        var end = $('#end').val();
        $.ajax({
            url: "<?php echo e(url("rrhh/createdesignacioPersonalgrupo")); ?>",
            type: "get",
...
</script><?php /**PATH C:\xampp\htdocs\Web\Modules/Rrhh\Resources/views/scarrhh/AsistenciasActuales/designaciones/personal/create-designacion.blade.php ENDPATH**/ ?>