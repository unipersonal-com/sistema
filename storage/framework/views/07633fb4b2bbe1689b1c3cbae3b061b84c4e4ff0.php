    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="background: #CBDEED">
                ...
                <?php echo Form::open(['route'=>'save.tipocontrato', 'role' => 'form', 'method' => 'post']); ?>

                <table class="table table-responsive">
                    
                    <tr>
                        <td><?php echo Form::label('nombre_tipo_contrato','Nombre de Tipo Contrato: '); ?></td>
                        <td><?php echo Form::text('nombre_tipo_contrato',null,["class"=>"form-control"]); ?></td>
                    </tr>

                    <tr>
                        <td><?php echo Form::label('tipo','Tipo: '); ?></td>
                        <td><?php echo Form::text('tipo','',["class"=>"form-control"]); ?></td>
                    </tr>
...
</div><?php /**PATH C:\xampp\htdocs\Web\Modules/Rrhh\Resources/views/scarrhh/tipocontrato/modals/modal-create.blade.php ENDPATH**/ ?>