    <!-- Modal -->
    <div class="modal modal-success fade actualizarDesignacion-modal-sm" id="modelIddesignacion" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background: #113F63;color:#fff">
                    <h5 class="modal-title" style="font-size: 17; font-weight: bold; text-transform: uppercase; text-align: center;"> Actualizar Designacion de Horarios</h5>
                ...
                <div class="modal-body" style="background: #CBDEED">
                    ...
                    <button type="button" class="btn btn-primary ActualizarGuardar" id="actualizarDesig">Guardar</button>
                    <button type="button" class="btn btn-primary eliminarGuardar" id="elimiarDesig">Eliminar</button>
    ...
    <script type="text/javascript">
        $(document).on('click','#actualizarDesig',function(e){
            //e.preventDefault();
            ...
            $(".actualizarDesignacion-modal-sm").modal("hide");
            $('#horario_id_edit').val(0);
            $('#start_edit').val('');
            $('#end_edit').val('');
        });
            ////////delete desiganacion de horarios en general por fecha.//////
        $(document).on('click','#elimiarDesig',function(e){
            //e.preventDefault();
            var horario_id = $('#horario_id_edit').val();
            var start = $('#start_edit').val();
            var end = $('#end_edit').val();
    ...
    </script><?php /**PATH C:\xampp\htdocs\Web\Modules/Rrhh\Resources/views/administrator/personal/modals/modal-actualizar.blade.php ENDPATH**/ ?>