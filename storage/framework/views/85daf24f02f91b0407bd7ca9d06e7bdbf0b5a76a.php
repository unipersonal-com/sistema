        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="background: #CBDEED">
                ...
                <table class="table table-responsive">
                    <?php echo $__env->make('admin.schedule.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </table>
...
<?php /**PATH C:\xampp\htdocs\Web\resources\views/admin/schedule/modals/modal-create.blade.php ENDPATH**/ ?>