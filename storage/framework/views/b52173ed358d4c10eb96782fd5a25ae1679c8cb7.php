        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="<?php echo e(asset('assets/images/uatf_azul.png')); ?>" alt="">
                </div>
            </div>
        </div>
    </div>
...
<footer>
    <div class="footer-wrappr " data-background="<?php echo e(asset('portal/img/gallery/footer-bg.png')); ?>">
                        ...
                        <div class="col-xl-12">
                            <div class="footer-copy-right text-center">
                                <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                  Copyright &copy;<script>document.write(new Date().getFullYear());</script> Todos Los Derechos Reservados | DATA-CENTER(AREA DE DESARROLLO) <a href="http://uatf.edu.bo" target="_blank">UATF</a>
...
<?php /**PATH C:\xampp\htdocs\Web\resources\views/layouts/portal.blade.php ENDPATH**/ ?>