    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="background: #CBDEED">
                <!-- <?php echo Form::open(['route'=>['editar.desigancionpersonal',Crypt::encrypt(0)], 'role' => 'form', 'method' => 'put']); ?> -->
...
<script type="text/javascript">
    ...
    $(document).on('click','#eliminarDe',function(e){
        ...
        console.log(id);
            ...
            if(bool){
                $.ajax({
                    url:"<?php echo e(url("rrhh/deletetedesignacionpersonalgrupo")); ?>",
                    type:"get",
                    data:{"id":id},
    ...
    function designar(){
        ...
        $.ajax({
            url: "<?php echo e(url("rrhh/updateDesgpersonalgrupo")); ?>",
            type: "get",
            data: {id, start, end},
...
</script><?php /**PATH C:\xampp\htdocs\Web\Modules/Rrhh\Resources/views/scarrhh/AsistenciasActuales/designaciones/model-edit.blade.php ENDPATH**/ ?>