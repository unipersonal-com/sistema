...
##parent-placeholder-518cf8338c525b9b9840516cc667fb67f75d82ca##
    ...
    <script>
        function alerta(id,row) {
            ...
            if(bool){
                $.ajax({
                    url:"<?php echo e(url("deleteShedules")); ?>",
                    type:"get",
                    data:{"id":id},
    ...
    <script type="text/javascript">
        ...
        function ver(id){
            $.ajax({
                url:"<?php echo e(url("getSchedule")); ?>",
                type:"get",
                data:{"id":id},
                success:function(datos){
...
<?php echo $__env->make('layouts.principal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Web\resources\views/admin/schedule/index.blade.php ENDPATH**/ ?>