                    ...
                    <table class="table table-responsive">
                        ...
                        <tr>
                            <td>
                              ...
                              <input type="date" class="form-control" name="start" id="starttp" min="1970-12-31" max="<?php echo e(DATE::now()->format('Y-m-d')); ?>" placeholder="2022-10-12">
                           </td> 
                           <td>
                              <label for="end" class="form-label">Fecha_fin</label>
                              <input type="date" class="form-control" name="end" id="endtp" min="1970-12-31" max="<?php echo e(DATE::now()->format('Y-m-d')); ?>"placeholder="2022-10-12">
                           </td> 
                        </tr>
                        </form>

                    </table>
                    <a class="btn btn-success permisos" id= "<?php echo e($id_persona); ?>" onclick="permisos(this.id, url='<?php echo e(url('rrhh/permisos')); ?>')" 
                                style="margin-top: 2px; color: #fff"><i class="fa fa-undo"></i> Calcular</a>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
    </div><?php /**PATH C:\xampp\htdocs\Web\Modules/Rrhh\Resources/views/scarrhh/vistasHojaCalculo/modals/modal-fepermiso.blade.php ENDPATH**/ ?>