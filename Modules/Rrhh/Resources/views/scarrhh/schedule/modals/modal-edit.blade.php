            ...
            <div class="modal-body" style="background: #CBDEED">
                ...
                <table class="table table-responsive">
                    ...
                    <tr>
                        ...
                        <td>{!! Form::number('late_minutes',0,['class'=>'form-control',"id"=>"late_minutes_edit", "min"=>'5', "max"=>'30']) !!}</td>
                        <td>{!! Form::label('early_minutes','Toler Sal(mins)') !!}</td>
                        <td>{!! Form::number('early_minutes',0,['class'=>'form-control',"id"=>"early_minutes_edit",'min'=>'5', "max"=>'360']) !!}</td>
                    </tr>
                    <tr>
                        <td>{!! Form::label('start_input','Inicio Ent:') !!}</td>
                        <td>{!! Form::time('start_input',null,['min'=>01, 'max'=>22, 'class'=>'form-control',"id"=>"start_input_edit"]) !!}</td>
                    ...
                    <tr>
                        ...
                        <td>{!! Form::time('start_output',null,['class'=>'form-control',"id"=>"start_output_edit", 'onclick'=>'cambio2()', 'min'=>"12:00", 'max'=>"22:00"]) !!}</td>
                        <td>{!! Form::label('end_output','Fin Sal:') !!}</td>
                        <td>{!! Form::time('end_output',null,['class'=>'form-control',"id"=>"end_output_edit", 'onclick'=>'cambio3()']) !!}</td>
                    </tr>
                    <tr>
