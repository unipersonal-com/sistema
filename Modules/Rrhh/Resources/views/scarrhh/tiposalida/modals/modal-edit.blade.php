    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="background: #CBDEED">
                <!-- <h4>Editar</h4> -->
                {!! Form::open(['route'=>['update.tiposalida',Crypt::encrypt(0)], 'role' => 'form', 'method' => 'put']) !!}
                {!! Form::hidden('id_edit',null,["value"=>"0","id"=>'id_edit'])!!}
                <table class="table table-responsive">
                    <tr>

                        <td>{!! Form::label('nombre_tiposalida','Nombre de Tipo Salida: ') !!}</td>
                        <td>{!! Form::text('nombre_tiposalida',null,["class"=>"form-control","id"=>'nombre_tiposalida_edit'])!!}</td>
                    </tr>
                    <tr>
