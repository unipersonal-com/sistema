    ...
    <tr>
      ...
      <td hidden="true">
        ...
        <input type="text" class="form-control" name="id_persona" id="id_persona" value="{{ $id_persona }}" placeholder="colocar id_persona" >
      </td>
      <td>
        <label for="nombre_p" class="form-label">nombre_p</label>
        <input type="text" class="form-control" name="nombre_p" id="nombre_p" value="{{ $persona->nombres.' '.$persona->apellido_paterno }}" placeholder="colocar nombre_p">
      </td>
    </tr>
    <tr>
