<div class="conatiner">
        ...
        <script type="text/javascript">
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventClick: function(arg) {
                    ...
                    $(function () {
                        ...
                        $.ajax({
                            ...
                            url:"{{ url("rrhh/getdesignacionesgrupo") }}",
                            type:"get",
                            data:{"id":id},
                ...
                dayMaxEvents: true,
                events: {
                    url: "{{url("rrhh/mostrardesignacionesg")}}",
                    method: "GET",
                    extraParams: {
                        id : '{{ $id_persona }}',
                    },
    ...
    @include('rrhh::scarrhh.AsistenciasActuales.designaciones.personal.create-designacion')
    @include('rrhh::scarrhh.AsistenciasActuales.designaciones.model-edit')
