...
<div class="conatiner">
        ...
        <script type="text/javascript">
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventClick: function(arg) {
                    ...
                    $(function () {
                        ...
                        $.ajax({
                            ...
                            url:"{{ url("rrhh/getAsistenciaActual") }}",
                            type:"get",
                            data:{"id":id},
                ...
                dayMaxEvents: true,
                events: {
                    url: "{{url("rrhh/mostrarasistencias")}}",
                    method: "GET",
                    extraParams: {
                        id : '{{ $id_persona }}',
                    },
    ...
    <div id='top'>
        <u style="margin-top: 20px; font-weight: bold; text-aling: center;"><h4 style="text-align: center;">{{$title}} <b>{{$persona->nombres.' '.$persona->apellido_paterno.' '.$persona->apellido_materno}}</b> </h4></u>
    <!-- Locales:
    ...
    <div>
    <div id="carga" style="display: none; background-color: #fff; text-align: center;"> <img src="{{{ asset('assets/images/loanding1.gif') }}}" width="250px" style="color: #900c3f;"></div>
                    ...
                    <table class="table table-responsive">
                        ...
                        <tr>
                            <td>
                              ...
                              <input type="date" class="form-control" name="start" id="start" min="1970-12-31" max="{{DATE::now()->format('Y-m-d')}}" placeholder="2022-10-12">
                           </td> 
                           <td>
                              <label for="end" class="form-label">Fecha_fin</label>
                              <input type="date" class="form-control" name="end" id="end" min="1970-12-31" max="{{DATE::now()->format('Y-m-d')}}"placeholder="2022-10-12">
                           </td> 
                        </tr>
                        </form>

                    </table>
                    <a class="btn btn-success as" id= "{{$id_persona}}" onclick="pdfgeneral(this.id, url='{{url('rrhh/pdfasistenciapersonal')}}')" 
    ...
    @include('rrhh::scarrhh.AsistenciasActuales.modals.edit')
    @include('rrhh::scarrhh.AsistenciasActuales.modals.modal-dtrabajo')
    ...
    <script type="text/javascript">
        ...
        function pdfgeneral(id, response){
            ...
            $.ajax({
                url: "{{url("rrhh/pdfasistenciapersonal")}}",
                type:"get",
