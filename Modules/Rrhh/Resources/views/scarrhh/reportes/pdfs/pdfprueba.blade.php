    ...
    @foreach ($per_tc as $tc)
      ...
      <div class="container">
        ...
        <table class="table__kiri table-bordered">
          ...
          <tbody>
            @foreach ($actualAsistencias as $asistencia)
              @if ($asistencia['ci'] == $tc->ci)
                <tr>
                  <td>{{$asistencia['fecha']}}</td>
                  <td>{{$asistencia['dia']}}</td>
                  <td>{{$asistencia['ci']}}</td>
                  <td>{{$asistencia['horario']}}</td>
                  <td>{{$asistencia['tipo1']}}</td>
                  <td>{{$asistencia['hora1']}}</td>
                  <td>{{$asistencia['estado1']}}</td>}</td>
                  <td>{{$asistencia['tipo2']}}</td>
                  <td>{{$asistencia['hora2']}}</td>
                  <td>{{$asistencia['estado2']}}</td>
                  <td>{{$asistencia['horatra']}}</td>
                  <td></td>
                  @php
                    $con_d ++;
            ...
            <tr id="total1">
                ...
                @endphp
                <td>{{($bonote/2) - $falti}}</td>
                <td> {{ $d_bonote}}</td>
                <td>{{ $d_bonote + ($auxbonote/2) }}</td>
                <td></td>
            </tr>
          </tbody>
        </table>
