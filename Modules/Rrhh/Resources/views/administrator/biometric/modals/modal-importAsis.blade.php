        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="background: #CBDEED">
                    {!! Form::open([ 'route'=>'admin.save.import', 'role' => 'form', 'method' => 'post', 'enctype' => 'multipart/form-data' ]) !!}
                    ...
                    <a class='btn btn-warning'  href='{{url('rrhh/ejemplodes')}}'' title="descargar ejemplo"><i class="fa fa-arrow-circle-down"> descargar ejemplo</i></a>
                    {!! Form::close() !!}
