                    ...
                    <tr class="yestd">
                      ...
                      <td width="3%">
                        <div class="btn-group" style=" margin-left: 0%;" role="group" aria-label="Basic example">
                            ...
                            title="HABILITAR A USUARIO PARA REGISTRO DE ASISTENCIA" disabled onclick="nobaja(idp='{{ $empl->id }}')"><i class="fa fa-circle-o" style="margin-left: -5px;"></i></a>
                            <a class="btn btn-danger darbaja" id= "{{ $empl->id }}" style="margin-top: 1px; border-radius: 20px; background: ; width:5px; text-aling: center;"
                      ...
                      <td width="3%">
                        <div class="btn-group" style=" margin-left: 0%;" role="group" aria-label="Basic example">
                            <a class="btn btn-warning nodarbaja" id= "nodarbaja" style="margin-top: 2px; color: #fff; border-radius: 20px; background: ; width:5px;"
                            title="HABILITAR A USUARIO PARA REGISTRO DE ASISTENCIA" onclick="nobaja(idp='{{ $empl->id }}')"><i class="fa fa-circle-o" style="margin-left: -5px;"></i></a>
                            <a class="btn btn-danger darbaja" id= "{{ $empl->id }}" style="margin-top: 1px; border-radius: 20px; background: ; width:5px; text-aling: center;"
                      ...
                      <td width="12%">
                        ...
                        <!-- <a class='btn btn-asistencias' id="{{ $empl->id }}" title=" ir a Asistencias para importar" onclick=" ajaxRenderSection2(this.id, url='{{url('rrhh/AsisActual')}}' )">
                        <i class="fa fa-book" style="color:white;"></i></a> -->
                        <div class="dropdown show">
                          <a class="btn btn-success dropdown-toggle btn-asistencias" title=" designar a un grupo al usuario :{{ $empl->nombres }}"
                          ...
                          <div class="dropdown-menu text-aling-center" aria-labelledby="dropdownMenuLink">
                            @foreach ($grupos as $grupo)
                              <a class="dropdown-item valores" data-id="{{ $grupo->id }}" id="{{ $empl->id }}"
                              onclick="designargrupo(this.id, idg='{{ $grupo->id }}', url='{{url('rrhh/guardarengrupo')}}')">{{$grupo->nombre_trabajo}}</a><br>
                            @endforeach
                          </div>
                        </div>
                        <a class='btn btn-enventos' id="{{ $empl->id }}" style="" title=" ir a Eventos de salida del usuario :{{ $empl->nombres }}" onclick="ajaxRenderSection(url='{{url('rrhh/eventossalida')}}', this.id)">
...
@include('rrhh::scarrhh.grupohorario.modals.modal-create')
@include('rrhh::scarrhh.grupohorario.modals.modal-actualizar')
@include('rrhh::scarrhh.reportes.modals.modal-reportegrupo')
@include('rrhh::scarrhh.reportes.modals.modal-repotetc')
@include('rrhh::scarrhh.reportes.xlss.modals.modal-exceltc')
@include('rrhh::scarrhh.reportes.modals.modal-reporteps')
</div>
@endsection
